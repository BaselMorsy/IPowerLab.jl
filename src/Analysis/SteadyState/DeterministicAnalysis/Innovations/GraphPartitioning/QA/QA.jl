...
@pyinclude("src/Analysis/SteadyState/DeterministicAnalysis/Innovations/GraphPartitioning/QA/dwave_call.py")

sample_qubo = pyimport("src.Analysis.SteadyState.DeterministicAnalysis.Innovations.GraphPartitioning.QA.dwave_call").sample_qubo

qubo_matrix = [[-1 0 3]; [0 2 1]; [ 0 0 -0.5]]

sample_qubo(qubo_matrix, solver="simulated_annealing")